      ...
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-700 mb-10 text-left">
            Estamos aqui para ajudar! Se você tiver alguma dúvida ou precisar de mais informações, não hesite em entrar em contato conosco. Nossa equipe terá prazer em responder.
          </p>
