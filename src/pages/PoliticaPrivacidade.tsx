          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-lg p-6 sm:p-8 md:p-10 shadow-lg">
              <div className="prose prose-lg max-w-none">
                ...
                {/* INTRODUÇÃO GERAL */}
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "0.25s" }}>INTRODUÇÃO GERAL</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.3s" }}>
                ...
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.35s" }}>
                ...
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.4s" }}>
                ...
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.45s" }}>
                ...
                <p className="text-gray-700 mb-6 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.5s" }}>
                  Esta Política de Privacidade poderá ser atualizada em decorrência de eventual atualização normativa, razão pela qual se convida o usuário a consultar periodicamente esta seção.
                </p>

                {/* Direitos do usuário */}
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "0.55s" }}>Direitos do usuário</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.6s" }}>
                  O aplicativo se compromete a cumprir as normas previstas no LGPD, em respeito aos seguintes princípios:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 text-sm sm:text-base" style={{ animationDelay: "0.65s" }}>
                ...
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.7s" }}>
                  O usuário do aplicativo possui os seguintes direitos, conferidos pela LGPD (Lei de Proteção de Dados Pessoais):
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 text-sm sm:text-base" style={{ animationDelay: "0.75s" }}>
                ...
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.8s" }}>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 text-sm sm:text-base" style={{ animationDelay: "0.85s" }}>
                ...
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.9s" }}>
                ...
                <p className="text-gray-700 mb-6 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "0.95s" }}>
                  <strong>Totel Tecnologia do Brasil Ltda</strong><br />
                  Avenida Gutemberg, 430 - Araraquara/SP - CEP 14810-180.
                </p>
                <p className="text-gray-700 mb-6 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                  O usuário será informado em caso de retificação ou eliminação dos seus dados.
                </p>

                {/* Dever de não fornecer dados de terceiros */}
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "1.0s" }}>Dever de não fornecer dados de terceiros</h2>
                <p className="text-gray-700 mb-6 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "1.0s" }}>Informações coletadas</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>4.1. Tipos de dados coletados</h3>
                
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 mt-4" style={{ animationDelay: "1.0s" }}>4.1.1. Dados de identificação do usuário para realização de cadastro</h4>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1 mb-4 text-sm sm:text-base" style={{ animationDelay: "1.0s" }}>
                  <li>nome</li>
                ...
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 mt-4" style={{ animationDelay: "1.0s" }}>4.1.2. Dados informados no formulário de contato</h4>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 mt-4" style={{ animationDelay: "1.0s" }}>4.1.3. Registros de acesso</h4>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 mt-4" style={{ animationDelay: "1.0s" }}>4.1.4. Newsletter</h4>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 mt-4" style={{ animationDelay: "1.0s" }}>4.1.5. Dados sensíveis</h4>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 mt-4" style={{ animationDelay: "1.0s" }}>4.1.6. Coleta de dados não previstos expressamente</h4>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>4.2. Fundamento jurídico para o tratamento dos dados pessoais</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>4.3. Finalidades do tratamento dos dados pessoais</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>4.4. Prazo de conservação dos dados pessoais</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>4.5. Destinatários e transferência dos dados pessoais</h3>
                <p className="text-gray-700 mb-6 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "1.0s" }}>Do tratamento dos dados pessoais</h2>
                
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>5.1. Do responsável pelo tratamento dos dados (data controller)</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>5.2. Da hospedagem dos dados</h3>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>5.3. Do encarregado de proteção de dados (data protection officer)</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "1.0s" }}>Segurança no tratamento dos dados pessoais do usuário</h2>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "1.0s" }}>Dados de navegação ( cookies )</h2>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>7.1. Cookies do aplicativo</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>7.2. Cookies de terceiros</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>7.3. Cookies de redes sociais</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 mt-6" style={{ animationDelay: "1.0s" }}>7.4. Gestão dos cookies e configurações do navegador</h3>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1 mb-6 text-sm sm:text-base" style={{ animationDelay: "1.0s" }}>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "1.0s" }}>Reclamação a uma autoridade de controle</h2>
                <p className="text-gray-700 mb-6 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                {/* Das alterações */}
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "1.0s" }}>Das alterações</h2>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-8" style={{ animationDelay: "1.0s" }}>Do Direito aplicável e do foro</h2>
                <p className="text-gray-700 mb-3 text-sm sm:text-base leading-relaxed" style={{ animationDelay: "1.0s" }}>
