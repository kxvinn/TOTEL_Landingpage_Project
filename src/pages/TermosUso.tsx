          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-lg p-6 sm:p-8 md:p-10 shadow-lg">
              <div className="prose prose-lg max-w-none">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Atualizações e Aceite</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Termo de Aceite</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Condições de Acesso e Uso do Aplicativo</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Utilização do Aplicativo</h2>
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Isenções de Responsabilidade</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 text-sm sm:text-base opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Hospedagem dos Dados</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Propriedade Intelectual</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Exclusão da Conta</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Comunicação com a TOTEL</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Término do Acesso</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-12 opacity-0 fade-in-element" >Disposições Finais</h2>
                <p className="text-gray-700 mb-4 text-sm sm:text-base leading-relaxed opacity-0 fade-in-element" >
                ...
                <p className="text-gray-600 text-sm opacity-0 fade-in-element" >
